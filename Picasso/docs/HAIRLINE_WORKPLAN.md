...
- **Owns:** delete `theme.css`, `useCSSVariables.js`, CSSVariablesProvider path, avatar pipeline, feature-display var machinery, Montserrat/Poppins leftovers; retire legacy `--*` names. **Status:** PR #672
