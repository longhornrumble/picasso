  ...
  function ConfigProvider({ children }) {
    ...
    const getTenantHash = () => {
      ...
      try {
        ...
        if (((_a = window.PicassoConfig) == null ? void 0 : _a.tenant) && window.PicassoConfig.tenant !== "undefined") {
    ...
    const startConfigWatcher = () => {
      ...
      console.log(`🕐 Config update checker started (every ${checkInterval / 1e3}s)`);
    };
...
🛠️  PICASSO NEW PURE HASH + ACTION SYSTEM COMMANDS:
  ...
  const useChat = () => {
    const context = reactExports.useContext(ChatContext);
    if (!context) {
...
🛠️  CHAT API TEST COMMANDS:
  ...
  function useCSSVariables(config) {
    reactExports.useEffect(() => {
      ...
      const isFullPage = ((_a = window.PicassoConfig) == null ? void 0 : _a.mode) === "fullpage";
      ...
      console.log("📊 Config structure validation:", {
        hasBranding: !!config.branding,
        hasFeatures: !!config.features,
        primaryColor: ((_b = config.branding) == null ? void 0 : _b.primary_color) || "using-default",
        tenantHash: config.tenant_hash || "missing",
        configSource: ((_c2 = config.metadata) == null ? void 0 : _c2.source) || "unknown"
      });
      ...
      const actionChipsConfig = (config == null ? void 0 : config.action_chips) || {};
      ...
      const cssVariables = {
        ...
        "--header-text-color": branding.header_text_color || branding.chat_title_color || branding.title_color || determineHeaderTextColor(branding),
        "--header-close-color": branding.header_close_color || branding.header_text_color || branding.chat_title_color || determineHeaderTextColor(branding),
        "--widget-icon-color": branding.widget_icon_color || branding.chat_toggle_icon_color || determineContrastColor(branding.widget_background_color || branding.primary_color || "#3b82f6"),
        "--widget-background-color": branding.widget_background_color || branding.chat_toggle_background_color || branding.primary_color || "#3b82f6",
      ...
      window.picassoDebug = {
        ...
        configSource: (_d = config.metadata) == null ? void 0 : _d.source
      };
      return () => {
...
📋 SYSTEM STATUS:
  ...
  function ChatHeader({ onClose }) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-header", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "chat-title", children: (_a = config.branding) == null ? void 0 : _a.chat_title }),
  ...
  function InputBar({ input, setInput }) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-bar-container", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-row-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-text-row", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            ref: textareaRef,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-controls-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-tools", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-tool-button", "data-voice": true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { size: 16 }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
  ...
  function FollowUpPromptBar() {
    ...
    if (!open) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "quick-help-toggle-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "quick-help-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
`;
  ...
  function FilePreview({ file, uploadState = "complete", onCancel }) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "8px" }, children: isImage && uploadState === "complete" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      width: "200px",
      height: "150px",
      borderRadius: "8px",
      overflow: "hidden",
      ...
      position: "relative"
    }, children: file.preview ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: file.preview,
        alt: file.name,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Image$1, { size: 24, style: { marginBottom: "4px" } }),
      file.name
    ] }) }) : (
      /* File Card */
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: __spreadValues({
        display: "flex",
        alignItems: "center",
        gap: "12px",
        padding: "12px",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          ...
          fontWeight: "600",
          flexShrink: 0
        }, children: uploadState === "error" ? "✗" : getFileTypeLabel(file.type) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
          ...
          uploadState === "uploading" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
            width: "100%",
            height: "4px",
  ...
  function MessageBubble({ role, content, files = [], actions = [], uploadState, onCancel }) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `message ${isUser ? "user" : "bot"}`, children: [
      !isUser && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "avatar-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "message-content", children: [
        content && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { dangerouslySetInnerHTML: { __html: html2 } }),
        (role === "assistant" || role === "bot") && actions && actions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "action-chips", children: actions.slice(0, ((_a = config == null ? void 0 : config.action_chips) == null ? void 0 : _a.max_display) || 5).map((action, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
  ...
  function TypingIndicator() {
    ...
    const borderRadius = ((_a = config == null ? void 0 : config.branding) == null ? void 0 : _a.border_radius) || "12px";
    const botBubbleColor = ((_b = config == null ? void 0 : config.branding) == null ? void 0 : _b.bot_bubble_color) || "#f3f4f6";
    const avatarShape = ((_c2 = config == null ? void 0 : config.branding) == null ? void 0 : _c2.avatar_shape) === "circle" ? "50%" : borderRadius;
    const handleAvatarError = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
        ...
        ` }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "typing-indicator-wrapper", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "bot-avatar",
  ...
  function ChatWidget() {
    ...
    const [isOpen, setIsOpen] = reactExports.useState(() => {
      ...
      try {
        const savedState = localStorage.getItem(`picasso_chat_state_${config == null ? void 0 : config.tenant_id}`);
        if (savedState !== null) {
    ...
    reactExports.useEffect(() => {
      const widgetConfig = (config == null ? void 0 : config.widget_behavior) || {};
      if (widgetConfig.remember_state && (config == null ? void 0 : config.tenant_id)) {
        try {
    ...
    }, [isOpen, (_a = config == null ? void 0 : config.widget_behavior) == null ? void 0 : _a.remember_state, config == null ? void 0 : config.tenant_id]);
    reactExports.useEffect(() => {
      const widgetConfig = (config == null ? void 0 : config.widget_behavior) || {};
    ...
    }, [(_b = config == null ? void 0 : config.widget_behavior) == null ? void 0 : _b.auto_open_delay, isOpen]);
    reactExports.useEffect(() => {
      if (isOpen) {
    ...
    }, [(_c2 = config == null ? void 0 : config.features) == null ? void 0 : _c2.photo_uploads, showAttachmentMenu]);
    const chatWindowRef = reactExports.useRef(null);
    const lastMessageRef = reactExports.useRef(null);
    const chat_title = (config == null ? void 0 : config.chat_title) || ((_d = config == null ? void 0 : config.branding) == null ? void 0 : _d.chat_title) || ((config == null ? void 0 : config.tenant_id) === "FOS402334" ? "Foster Village" : "Chat");
    ...
    const calloutConfig = ((_e = config == null ? void 0 : config.features) == null ? void 0 : _e.callout) || {};
    const calloutEnabled = typeof calloutConfig === "object" ? calloutConfig.enabled !== false : ((_f = config == null ? void 0 : config.features) == null ? void 0 : _f.callout) !== false;
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChatHeader, { onClose: () => {
          console.log("❌ Chat closed via header");
          setIsOpen(false);
        } }),
  ...
  function MessageList({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          messages && messages.map((msg, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(React.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "message-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            MessageBubble,
            {
              role: msg.role,
              content: msg.content,
          ...
          isTyping && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "typing-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TypingIndicator, {}) }),
  ...
  function FullPageChat() {
    ...
    reactExports.useEffect(() => {
      var _a2;
      if ((_a2 = config == null ? void 0 : config.branding) == null ? void 0 : _a2.chat_title) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fullpage-chat-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fullpage-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ChatHeader,
        {
          onClose: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fullpage-messages", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        MessageList,
        {
          enableAutoScroll: true,
          scrollBehavior: "smooth"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fullpage-input-area", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fullpage-input-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          InputBar,
          {
            input,
            setInput,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChatFooter,
          {
            brandText: ((_a = config == null ? void 0 : config.branding) == null ? void 0 : _a.brandText) || "AI",
            fullPageMode: true
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fullpage-branding", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "Powered by ",
        ((_b = config == null ? void 0 : config.branding) == null ? void 0 : _b.brandText) || "AI"
      ] }) })
    ] });
  }
  function App() {
    var _a;
    const mode = ((_a = window.PicassoConfig) == null ? void 0 : _a.mode) || "widget";
    const isFullPage = mode === "fullpage";
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ConfigProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CSSVariablesProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChatProvider, { children: isFullPage ? /* @__PURE__ */ jsxRuntimeExports.jsx(FullPageChat, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChatWidget, {}) }) }) });
  }
  if (typeof window !== "undefined") {
  ...
  class PicassoWidget {
    ...
    getTenantId() {
      try {
        const script = document.currentScript || document.querySelector('script[src*="widget.js"]') || document.querySelector("script[data-tenant]");
        if (script == null ? void 0 : script.getAttribute("data-tenant")) {
    ...
    getMode() {
      try {
        ...
        const modeFromScript = script == null ? void 0 : script.getAttribute("data-mode");
    ...
    showFallback(error) {
      ...
      `;
        setTimeout(() => {
          var _a;
          if ((_a = this.container) == null ? void 0 : _a.innerHTML) {
            this.container.innerHTML = "";
          }
        }, 1e4);
      } catch (fallbackError) {
  ...
  if (typeof window !== "undefined") {
    window.Picasso = {
      ...
      version: "1.0.0"
      // Remove __APP_VERSION__ reference that causes build issues
    };
  }
