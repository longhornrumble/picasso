...
**Closes:**
- D5: G-K (executes); F-DSAR1 / F-DSAR3 / F-DSAR4 (design-only stubs with named triggers); **F-DSAR22 CLOSED 2026-05-23 via M9.G6 ship**; **F-DSAR20 CLOSED 2026-05-24 via M9.G4 ship** (playbook §3.1/§4.1/§6.1 prod-CLI variants + tools/dsar-invoke.sh safety wrapper); F-DSAR21 (broader prod-IaC-drift gap; expanded scope absorbs the M9.G7 prod-UpdateTimeToLive sub-item + the M9.G4 Sprint B placeholder-body anomaly, closes when M9.G5 trigger fires); **F-DSAR26 CLOSED 2026-05-24 via M9.G7 ship** (CW Errors alarm + DLQ); **F-DSAR27 PARTIAL CLOSED 2026-05-24** (4 unit tests + format pinning shipped; integration suite deferred-with-trigger per M9.G7); **F-DSAR28 CLOSED 2026-05-24 via M9.G7 ship** (47 smoke rows closed + playbook §8 filter); **F-DSAR24 CLOSED 2026-05-24 via M9.G8 ship** (option 3 variant — structured log + CW Logs metric filter + alarm; rejected option 1 fail-closed + option 2 DLQ+retry with rationale recorded); **F-DSAR25 CLOSED 2026-05-24 via M9.G8 ship** (escapeHtml wrap on default-path HTML body).
...
| F-DSAR21 | Prod hand-managed IaC drift on PII surfaces | OPEN M/M | **M9.G5** (drift audit script; quarterly cadence + prod-CT-CW-Logs export sub-item routed here from M9.G7) |
