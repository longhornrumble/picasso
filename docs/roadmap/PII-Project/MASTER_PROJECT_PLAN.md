...
| F-DSAR24 | BSH `form_handler.js` silent DDB write catch | OPEN L/H | **M9.G8** (priority queue active item; BSH writer hardening; calendar backstop 2026-06-22) |
| F-DSAR25 | Unescaped form_data in staff notification email HTML | OPEN L/M | **M9.G8** (batched with F-DSAR24; calendar backstop 2026-06-22) |
