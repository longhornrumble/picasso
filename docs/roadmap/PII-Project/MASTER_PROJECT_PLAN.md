...
**Row count check:** 31 rows total (D5 register currently lists 24 row-entries including 12 unique F-DSAR rows + G-A/B/C/D/E/F/G/H/I/J/K + F9/F11/F12/F13+F15). The §6 expansion above lists all 31 routing entries explicitly — 11 G-letter rows + 4 F-series + 16 F-DSAR rows. CLOSED rows retained in table for traceability.
