...
| F-DSAR20 | Operator playbook prod-CLI variant not documented/tested | OPEN L/H | **M9.G4** (priority queue active item; calendar backstop 2026-06-22) |
