...
from jwt_coordination import load_signing_key, perform_jwt_startup_check
...
def validate_jwt_token(token, security_context):
    ...
    try:
        ...
        # Use tolerant key loader for consistent parsing
        signing_key = load_signing_key(secret_data)
