...
import { errorLogger } from '../src/utils/errorHandling';
import { config as environmentConfig } from '../src/config/environment';
...
export const validateStreamingEndpoint = async (streamingEndpoint, tenantHash) => {
  ...
  try {
    ...
    // Test connection with a minimal EventSource request
